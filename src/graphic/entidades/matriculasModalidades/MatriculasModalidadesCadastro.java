...
public class MatriculasModalidadesCadastro extends EntidadesCadastro {
    private MatriculasCadastro matriculasCadastro;
    ...
    public MatriculasModalidadesCadastro(MatriculasModalidadesModel matriculasModalidadesModelEditando,
                                         MatriculasCadastro matriculasCadastro,
                                         MatriculasModel matriculasModel) {
        this.matriculasCadastro = matriculasCadastro;
    ...
    protected void onClickSalvar() {
        ...
        matriculasCadastro.atualizarDadosTabela();
    }
