...
import graphic.entidades.matriculasModalidades.MatriculasModalidadesCadastro;
...
public class MatriculasCadastro extends EntidadesCadastro {
    ...
    public MatriculasCadastro(MatriculasModel matriculasModelEditando, MatriculasPanel matriculasPanel) {
    ...
    protected void onClickNovaModalidade() {
        if(matriculasModel.getDataEncerramento() == null){
            MatriculasModalidadesCadastro matriculasModalidadesCadastro = new MatriculasModalidadesCadastro(null, this, matriculasModel);
